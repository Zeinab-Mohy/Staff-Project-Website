...
<head>
    ...
    <title>Sadat_University_Staff_Portal</title>
...
<body>
    <?php
        ...
        $query="SELECT first_name,second_name FROM staff
         where id=$id";
        ...
        <div class="sub-menu-wrap" id="subMenu">
            <div class="sub-menu">
                <div class="user-info">
                    ...
                    <h5 style="color:#070D59; font-weight: 550;">
                        <?php echo $first_name." ".$second_name; ?>
                    </h5>
                </div>
                <hr>
                <form action="" method="POST">
                    <input type="submit" name="edit_profile" value=" Edit Profile" class="sub-menu-link" >
                    <input type="submit" name="log_out" value="    Log Out" class="sub-menu-link">
                </form>
            </div>
        </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner"  >
              <div class="carousel-item active">
                <img src=" University2.jpg" class="d-block w-100" alt="..." style="height: 550px; width: 80%;" >
              </div>
    ...
    <div class="features text-center pt-5" id="s">
        <div class="container" >
                ...
                <div class="container-form">
                    ...
                    <form action="./search.php" method="POST">
                        <div class="search-bar">
                            ...
                            <select id="departements" name="faculty" placeholder="faculty...">
    ...
    <!-- <div class="our-team text-center pb-5 pt-5">
        <div class="container">
            ...
            <br>
            <p class="text-center mb-5" style="color: #070D59; font-size: 20px; ">Persons with a position or influence on USE or FCAI community</p>
                    ...
                    <div class="links ">
                        ...
                        <div class="list pt-4">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="list-style-type:disc;">
                                <li class="nav-item">
                                    <a class="nav-link py-lg-1 " href="index_main.php">HOME</a>
                                </li>
                                <li class="nav-item">
