<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        function isEduEmail($email){
            $email = explode("@",$email);
            if($email[count($email)-1] == "fcai.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "fop.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "vet.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "law.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "com.usc.edu.eg")
              return true;
            else if ($email[count($email) - 1] == "phed.usc.edu.eg")
              return true;
              else if($email[count($email)-1] == "fch.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "edu.usc.edu.eg")
              return true;
            else if ($email[count($email) - 1] == "fth.usc.edu.eg")
              return true;
              else if($email[count($email)-1] == "esri.usc.edu.eg")
              return true;
            else if($email[count($email)-1] == "gepri.usc.edu.eg")
              return true;
              return false;
          }
