...
<?php
        ...
        // $cond=$id;
        $ch=0;
        $delete_img=$_POST["image"];
        // echo $delete_img;
        if(isset($_POST['update'])){
            // unlink('img/profile_img/'. $delete_img);
            require("../Controller/log_in_submit.php");
            $ob=new DB();
            $id=$_POST['id']; 
...
<div class="profile-card"> 
    ...
    <div >
    <img src="../img/profile_img/<?php echo $_POST["image"]; ?>" width = 200 title="<?php echo $_POST['image']; ?>" class="image">
    </div>
